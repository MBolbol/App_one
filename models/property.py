...
class Property(models.Model):
    ...
    # read
    @api.model
    def _search(self, domain, offset=False, limit=None, order=None, access_rights_uid=None):
        res = super(Property, self)._search(domain, offset=False, limit=None, order=None, access_rights_uid=None)
        # logic
